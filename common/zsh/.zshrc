...
export PATH=$HOME/bin:$HOME/.cargo/bin:/usr/local/bin:$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:$PATH
...
plugins=(git archlinux jsontools node npm tmux docker docker-compose asdf)
