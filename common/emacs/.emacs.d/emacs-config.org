...
#+begin_src emacs-lisp
  (use-package org-notify
    :unless (or VS/IS-ANDROID VS/IS-MACOS)
    :after org
    :config
    (org-notify-start 60)
  ...
  (use-package fontaine
    ...
    (fontaine-presets
     `((small
        ...
        :default-height ,(if VS/IS-MACOS 140 100)
        :variable-pitch-family "Noto Sans")
       (regular) ; like this it uses all the fallback values and is named `regular'
       (medium
        :default-weight semilight
        :default-height ,(if VS/IS-MACOS 180 140)
        :bold-weight extrabold)
       (large
        :inherit medium
        :default-height ,(if VS/IS-MACOS 220 180))
       (presentation
        :inherit medium
       ...
       (t
        ...
        :default-height ,(if VS/IS-MACOS 160 120)
