...
#+begin_src emacs-lisp
  (defmacro vs/load-snippets (mode)
    ...
    `(let ((remaped-mode (alist-get ,mode major-mode-remap-alist ,mode)))
       (with-eval-after-load remaped-mode
         (message "[%s] loading snippets..." remaped-mode)
         (load (format "%s/%s.el" vs/snippets-dir ,mode))
         (message "[%s] snippets loaded!" remaped-mode))))
#+end_src
...
#+begin_src emacs-lisp
  (use-package typescript-ts-mode
    ...
    (vs/load-snippets 'javascript-mode))
#+end_src
