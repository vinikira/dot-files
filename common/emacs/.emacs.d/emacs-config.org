...
#+begin_src emacs-lisp
  (use-package org-project
    :after (org project)
    :elpaca (org-project :type git :host github :repo "delehef/org-project")
    :custom
...
#+begin_src emacs-lisp
  (use-package project
    :bind (:map project-prefix-map
                ("C-o l" . vs/project-dir-locals)
                ("C-o d" . vs/project-db-file)
                ("C-o a" . vs/project-api-file)
                ("C-o r" . vs/project-runbook)
...
#+begin_src emacs-lisp
  (use-package kubernetes-tramp
    :if (not VS/IS-EMACS-29)
    :custom (tramp-remote-shell-executable "sh"))
#+end_src
