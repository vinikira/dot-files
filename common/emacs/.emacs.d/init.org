...
#+begin_src emacs-lisp
  ...
  (define-advice web-mode-guess-engine-and-content-type (:around (f &rest r) guess-engine-by-extension)
    (if (and buffer-file-name
             (equal "ex" (file-name-extension buffer-file-name)))
  ...
  (use-package evil-leader
    :config (progn
              ...
              (evil-leader/set-key
                "ff" 'find-file
                "bbj" 'bookmark-jump
                "bb4j" 'bookmark-jump-other-window
                "bb5j" 'bookmark-jump-other-frame
                "bbs" 'bookmark-set
                "bbl" 'bookmark-bmenu-list
                "bl" 'switch-to-buffer
                "bs" 'save-buffer
                "bw" 'write-file
                "bk" 'kill-buffer
                ...
                ;; Docker
                "dd" 'docker
                "dcl" 'docker-compose-logsump-other-window
                ;; Magit
                "gs" 'magit-status
                "gb" 'magit-blame
  ...
  (use-package lsp-mode
    ...
    :hook ((lsp-mode . lsp-enable-which-key-integration)
           ((js2-mode rust-mode elixir-mode
                      typescript-mode java-mode dart-mode) . lsp)))
#+end_src
