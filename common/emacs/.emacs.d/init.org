...
#+begin_src emacs-lisp
  (use-package company
    :commands (company-complete-common
               ...
               global-company-mode company-grab-line)
    :init
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-mode
    ...
    :config (progn (customize-set-variable 'lsp-auto-guess-root t)
                 (customize-set-variable 'lsp-keymap-prefix "H-l")
                 (customize-set-variable 'lsp-file-watch-ignored
                                         (-concat vs/lsp-ignore-files lsp-file-watch-ignored))
...
#+begin_src emacs-lisp
  (use-package polymode
    ...
    :commands (pm-host-chunkmode
              pm-inner-chunkmode
              pm--config-name pm--get-keylist.keymap-from-parent
              pm-polymode pm-initialize
              pm-base-buffer pm-turn-polymode-off
